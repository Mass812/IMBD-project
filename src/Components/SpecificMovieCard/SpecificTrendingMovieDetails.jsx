...
const SpecificTrendingMovieDetails = () => {
	...
	useEffect(() => {
		axios(`https://api.themoviedb.org/3/movie/${newID}/videos?api_key=2121f2ad7169f32e4b2cab5cf77d32cd`)
						...
						<div className='text-movie-cont'>
							...
							<div
								...
								{n.production_companies.splice(0, 3).map((el, ind) => (
									<section key={ind} style={{ color: 'white', paddingTop: '15px' }}>
							...
							{videos.length ? (
								...
								<h5
									...
									Sorry, there is no trailer information in the movieDetailsbase for this movie.
								</h5>
							)}
							<div />
						</div>
